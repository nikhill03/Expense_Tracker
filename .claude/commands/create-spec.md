---
description: Create a spec file and feature branch for the next Bahi-Khata step
...
Bahi-Khata expense tracker. Always follow the rules in CLAUDE.md.
...
it exists at this stage of the Bahi-Khata roadmap.
