...
This step establishes the **data layer foundation** for the Bahi-Khata application.
...
- Opens connection to `expense_tracker.db` in project root
- Sets:
